...
<title>Restaurant.com AutoComplete</title>
<!--Bootstrap CSS-->
...
<div class="container">
	<div class="row" style="margin-top:100px;">
		<div class="col-lg-12">
		<h2><i class="fa fa-globe" aria-hidden="true"></i>&nbsp; Restaurant.com AutoComplete Example</h2>
		</div>
		
		<div class="col-md-6">
		<input type="text" id="restaurantpicker" class="form-control" placeholder="Start typing.." />
		...
		<div class="col-md-6">
		<p>This is a demo of an AutoComplete script for pulling data from Restaurant.com and displaying the results in an auto-complete style result box.</p>
		<p>Begin typing your search term in the input box and you will be able to see and get real-time data from Restaurant.com for:</p>
			...
			<ul>
				<li>Participating restaurants that have a listing on restaurant.com</li>
			</ul>
